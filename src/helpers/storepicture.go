...
func StorePictureInLocalFolder(file multipart.File, hfile *multipart.FileHeader, folder string) (string, error) {
	...
	// Criar um arquivo dentro da pasta profilePictures, porém o arquivo ainda está vázio
	...
	// cola essa cópia dentro do novo arquivo criado na função anterior (localProfilePicture)
